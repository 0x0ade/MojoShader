...
INSTRUCTION(NOP, "EXEC", 0, NULL, MOJOSHADER_TYPE_ANY)
INSTRUCTION(NOP, "EXECEND", 0, NULL, MOJOSHADER_TYPE_ANY)
INSTRUCTION(NOP, "CONDEXEC", 0, NULL, MOJOSHADER_TYPE_ANY)
INSTRUCTION(NOP, "CONDEXECEND", 0, NULL, MOJOSHADER_TYPE_ANY)
INSTRUCTION(NOP, "CONDEXECPRED", 0, NULL, MOJOSHADER_TYPE_ANY)
INSTRUCTION(NOP, "CONDEXECPREDEND", 0, NULL, MOJOSHADER_TYPE_ANY)
INSTRUCTION(NOP, "LOOPSTART", 0, NULL, MOJOSHADER_TYPE_ANY)
INSTRUCTION(NOP, "LOOPEND", 0, NULL, MOJOSHADER_TYPE_ANY)
INSTRUCTION(NOP, "CONDCALL", 0, NULL, MOJOSHADER_TYPE_ANY)
INSTRUCTION(RET, "RET", 0, NULL, MOJOSHADER_TYPE_ANY)
INSTRUCTION(NOP, "CONDJMP", 0, NULL, MOJOSHADER_TYPE_ANY)
INSTRUCTION(NOP, "ALLOC", 0, NULL, MOJOSHADER_TYPE_ANY)
